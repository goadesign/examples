...
// endpoint.
func DecodeUploadRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*updown.UploadPayload, error) {
	return func(r *http.Request) (*updown.UploadPayload, error) {
		var (
			dir         string
			contentType string
			err         error
...
// download endpoint.
func DecodeDownloadRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (string, error) {
