...
import (
	...
	sessionsvr "goa.design/examples/cookies/gen/http/session/server"
...
func handleHTTPServer(ctx context.Context, u *url.URL, sessionEndpoints *session.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
