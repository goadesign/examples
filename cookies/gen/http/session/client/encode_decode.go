...
func (c *Client) BuildCreateSessionRequest(ctx context.Context, v any) (*http.Request, error) {
...
func EncodeCreateSessionRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
...
func (c *Client) BuildUseSessionRequest(ctx context.Context, v any) (*http.Request, error) {
...
// use_session server.
func EncodeUseSessionRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
	return func(req *http.Request, v any) error {
