...
func DecodeListRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*concerts.ListPayload, error) {
	return func(r *http.Request) (*concerts.ListPayload, error) {
		var payload *concerts.ListPayload
		var (
			page  int
			limit int
			err   error
...
func DecodeCreateRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*concerts.ConcertPayload, error) {
	return func(r *http.Request) (*concerts.ConcertPayload, error) {
		var payload *concerts.ConcertPayload
		var (
...
func DecodeShowRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*concerts.ShowPayload, error) {
	return func(r *http.Request) (*concerts.ShowPayload, error) {
		var payload *concerts.ShowPayload
		var (
			concertID string
			err       error
...
func DecodeUpdateRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*concerts.UpdatePayload, error) {
	return func(r *http.Request) (*concerts.UpdatePayload, error) {
		var payload *concerts.UpdatePayload
		var (
...
func DecodeDeleteRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*concerts.DeletePayload, error) {
	return func(r *http.Request) (*concerts.DeletePayload, error) {
		var payload *concerts.DeletePayload
		var (
			concertID string
			err       error
