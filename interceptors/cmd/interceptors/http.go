...
func handleHTTPServer(ctx context.Context, u *url.URL, interceptorsEndpoints *interceptors.Endpoints, wg *sync.WaitGroup, errc chan error, dbg bool) {
	...
	// Configure the mux.
	interceptorssvr.Mount(mux, interceptorsServer)
	...
	for _, m := range interceptorsServer.Mounts {
