...
// endpoint.
func DecodeGetRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*interceptors.GetPayload, error) {
	return func(r *http.Request) (*interceptors.GetPayload, error) {
...
// create endpoint.
func DecodeCreateRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*interceptors.CreatePayload, error) {
	return func(r *http.Request) (*interceptors.CreatePayload, error) {
		var payload *interceptors.CreatePayload
		var (
...
// stream endpoint.
func DecodeStreamRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*interceptors.StreamPayload, error) {
	return func(r *http.Request) (*interceptors.StreamPayload, error) {
		var payload *interceptors.StreamPayload
		var (
			tenantID string
			auth     string
			err      error
