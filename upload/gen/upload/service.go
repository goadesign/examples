...
// The upload service exposes the methods required to implement the tus protocol
type Service interface {
	...
	Patch(context.Context, *PatchPayload) (res *PatchResult, err error)
	...
	// new upload resource.
	Post(context.Context, *PostPayload) (res *PostResult, err error)
...
// HeadPayload is the payload type of the upload service head method.
...
// HeadResult is the result type of the upload service head method.
...
// PatchResult is the result type of the upload service patch method.
...
// OptionsResult is the result type of the upload service options method.
...
// PostPayload is the payload type of the upload service post method.
...
// PostResult is the result type of the upload service post method.
...
// DeletePayload is the payload type of the upload service delete method.
...
// DeleteResult is the result type of the upload service delete method.
