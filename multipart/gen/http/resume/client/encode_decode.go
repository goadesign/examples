...
func unmarshalStoredResumeResponseToResumeviewsStoredResumeView(v *StoredResumeResponse) *resumeviews.StoredResumeView {
	...
	for i, val := range v.Experience {
		res.Experience[i] = unmarshalExperienceToResumeviewsExperienceView(val)
	}
	res.Education = make([]*resumeviews.EducationView, len(v.Education))
	for i, val := range v.Education {
		res.Education[i] = unmarshalEducationToResumeviewsEducationView(val)
	}

	return res
}

// unmarshalExperienceToResumeviewsExperienceView builds a value of type
// *resumeviews.ExperienceView from a value of type *Experience.
func unmarshalExperienceToResumeviewsExperienceView(v *Experience) *resumeviews.ExperienceView {
...
// unmarshalEducationToResumeviewsEducationView builds a value of type
// *resumeviews.EducationView from a value of type *Education.
func unmarshalEducationToResumeviewsEducationView(v *Education) *resumeviews.EducationView {
