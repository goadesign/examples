...
type StoredResumeResponse struct {
	...
	Experience []*Experience `form:"experience,omitempty" json:"experience,omitempty" xml:"experience,omitempty"`
	// Education section in the resume
	Education []*Education `form:"education,omitempty" json:"education,omitempty" xml:"education,omitempty"`
}
...
func ValidateStoredResumeResponse(body *StoredResumeResponse) (err error) {
	...
	for _, e := range body.Experience {
		if e != nil {
			if err2 := ValidateExperience(e); err2 != nil {
	...
	for _, e := range body.Education {
		if e != nil {
			if err2 := ValidateEducation(e); err2 != nil {
				err = goa.MergeErrors(err, err2)
			}
		}
	}
...
// ValidateExperience runs the validations defined on Experience
func ValidateExperience(body *Experience) (err error) {
	if body.Company == nil {
...
// ValidateEducation runs the validations defined on Education
func ValidateEducation(body *Education) (err error) {
