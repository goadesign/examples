...
func marshalResumeviewsStoredResumeViewToStoredResumeResponse(v *resumeviews.StoredResumeView) *StoredResumeResponse {
	...
	if v.Experience != nil {
		res.Experience = make([]*Experience, len(v.Experience))
		for i, val := range v.Experience {
			res.Experience[i] = marshalResumeviewsExperienceViewToExperience(val)
		}
	}
	if v.Education != nil {
		res.Education = make([]*Education, len(v.Education))
		for i, val := range v.Education {
			res.Education[i] = marshalResumeviewsEducationViewToEducation(val)
		}
	}
...
// marshalResumeviewsExperienceViewToExperience builds a value of type
// *Experience from a value of type *resumeviews.ExperienceView.
func marshalResumeviewsExperienceViewToExperience(v *resumeviews.ExperienceView) *Experience {
	res := &Experience{
		Company:  *v.Company,
		Role:     *v.Role,
		Duration: *v.Duration,
...
// marshalResumeviewsEducationViewToEducation builds a value of type *Education
// from a value of type *resumeviews.EducationView.
func marshalResumeviewsEducationViewToEducation(v *resumeviews.EducationView) *Education {
	res := &Education{
