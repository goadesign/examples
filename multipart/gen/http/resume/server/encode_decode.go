...
func marshalResumeviewsStoredResumeViewToStoredResumeResponse(v *resumeviews.StoredResumeView) *StoredResumeResponse {
	...
	if v.Education != nil {
		res.Education = make([]*ExperienceResponse, len(v.Education))
		for i, val := range v.Education {
			res.Education[i] = marshalResumeviewsEducationViewToExperienceResponse(val)
		}
	}
...
// marshalResumeviewsEducationViewToExperienceResponse builds a value of type
// *ExperienceResponse from a value of type *resumeviews.EducationView.
func marshalResumeviewsEducationViewToExperienceResponse(v *resumeviews.EducationView) *ExperienceResponse {
	res := &ExperienceResponse{}
