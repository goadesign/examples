...
func Mount(mux goahttp.Muxer, h *Server) {
	...
	MountGenHTTPOpenapi3JSON(mux, goahttp.ReplacePrefix("/openapi3.json", "/gen/http/openapi3.json", h.GenHTTPOpenapi3JSON))
	MountGenHTTPOpenapi3Yaml(mux, goahttp.ReplacePrefix("/openapi3.yaml", "/gen/http/openapi3.yaml", h.GenHTTPOpenapi3Yaml))
}
