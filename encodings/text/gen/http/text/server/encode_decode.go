...
func DecodeConcatstringsRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*text.ConcatstringsPayload, error) {
	return func(r *http.Request) (*text.ConcatstringsPayload, error) {
		var payload *text.ConcatstringsPayload
		var (
			a string
			b string
...
func DecodeConcatbytesRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*text.ConcatbytesPayload, error) {
	return func(r *http.Request) (*text.ConcatbytesPayload, error) {
		var payload *text.ConcatbytesPayload
		var (
			a string
			b string
...
func DecodeConcatstringfieldRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*text.ConcatstringfieldPayload, error) {
	return func(r *http.Request) (*text.ConcatstringfieldPayload, error) {
		var payload *text.ConcatstringfieldPayload
		var (
			a string
			b string
...
func DecodeConcatbytesfieldRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*text.ConcatbytesfieldPayload, error) {
	return func(r *http.Request) (*text.ConcatbytesfieldPayload, error) {
		var payload *text.ConcatbytesfieldPayload
		var (
			a string
			b string
