...
Example:
    `+os.Args[0]+` text concatstrings --a "Suscipit et quae soluta reiciendis quo totam." --b "Numquam aut tempora itaque nulla quo."
`, os.Args[0])
}
...
Example:
    `+os.Args[0]+` text concatbytes --a "Qui ut voluptatum culpa." --b "Dicta vel quo."
`, os.Args[0])
}
...
Example:
    `+os.Args[0]+` text concatstringfield --a "Magnam quis explicabo magnam eius et." --b "Culpa dolor eligendi recusandae aliquam."
`, os.Args[0])
}
...
Example:
    `+os.Args[0]+` text concatbytesfield --a "Quas nobis illum accusamus repudiandae." --b "Est voluptatem omnis sapiente nihil molestiae."
`, os.Args[0])
}
