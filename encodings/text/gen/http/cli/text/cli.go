...
Example:
    %[1]s text concatstrings --a "Et nulla quae nesciunt nemo." --b "Molestiae quis aut sit modi deserunt libero."
`, os.Args[0])
}
...
Example:
    %[1]s text concatbytes --a "Necessitatibus ipsum officiis illum aut." --b "Tempore aut amet rerum consectetur."
`, os.Args[0])
}
...
Example:
    %[1]s text concatstringfield --a "Eos accusantium deleniti inventore dolorum maxime." --b "Voluptas optio modi asperiores nesciunt eligendi."
`, os.Args[0])
}
...
Example:
    %[1]s text concatbytesfield --a "Inventore nobis officiis quasi iusto." --b "Laudantium quia consectetur quisquam maiores."
`, os.Args[0])
}
