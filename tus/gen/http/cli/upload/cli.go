...
func UsageExamples() string {
	return os.Args[0] + ` tus head --id "8aqlkb7mndpeb3648oqv" --tus-resumable "1.0.0"` + "\n" +
		""
}
...
Example:
    %[1]s tus head --id "8aqlkb7mndpeb3648oqv" --tus-resumable "1.0.0"
`, os.Args[0])
}
...
Example:
    %[1]s tus patch --id "699sor988m6epo5784nk" --tus-resumable "1.0.0" --upload-offset 3237920552917083987 --upload-checksum "sha1 Kq5sNclPz7QV2+lfQIuc6R7oRu0=" --stream "goa.png"
`, os.Args[0])
}
...
Example:
    %[1]s tus delete --id "tjsg4o54lk78aokvio5e" --tus-resumable "1.0.0"
`, os.Args[0])
}
