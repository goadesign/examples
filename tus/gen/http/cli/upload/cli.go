...
func UsageExamples() string {
	return os.Args[0] + ` tus head --id "cse4cgk0a32da4uhuag6" --tus-resumable "1.0.0"` + "\n" +
		""
}
...
Example:
    %[1]s tus head --id "cse4cgk0a32da4uhuag6" --tus-resumable "1.0.0"
`, os.Args[0])
}
...
Example:
    %[1]s tus patch --id "t7ugspuspu5n59446v4r" --tus-resumable "1.0.0" --upload-offset 3237920552917083987 --upload-checksum "sha1 Kq5sNclPz7QV2+lfQIuc6R7oRu0=" --stream "goa.png"
`, os.Args[0])
}
...
Example:
    %[1]s tus delete --id "tde8l3ef66mprkdbln3c" --tus-resumable "1.0.0"
`, os.Args[0])
}
