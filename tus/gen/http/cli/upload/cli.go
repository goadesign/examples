...
func UsageExamples() string {
	return os.Args[0] + ` tus head --id "grh71o55r8od8ge5dsol" --tus-resumable "1.0.0"` + "\n" +
		""
}
...
Example:
    %[1]s tus head --id "grh71o55r8od8ge5dsol" --tus-resumable "1.0.0"
`, os.Args[0])
}
...
Example:
    %[1]s tus patch --id "e6a8t9gkvsbv3v623fo3" --tus-resumable "1.0.0" --upload-offset 3237920552917083987 --upload-checksum "sha1 Kq5sNclPz7QV2+lfQIuc6R7oRu0=" --stream "goa.png"
`, os.Args[0])
}
...
Example:
    %[1]s tus delete --id "h2ntkdj8tf8m4lmr8dks" --tus-resumable "1.0.0"
`, os.Args[0])
}
