...
func UsageExamples() string {
	return os.Args[0] + ` tus head --id "f2spcurv8svn38ohtlu0" --tus-resumable "1.0.0"` + "\n" +
		""
}
...
Example:
    %[1]s tus head --id "f2spcurv8svn38ohtlu0" --tus-resumable "1.0.0"
`, os.Args[0])
}
...
Example:
    %[1]s tus patch --id "7gb59g747ah86riet958" --tus-resumable "1.0.0" --upload-offset 3237920552917083987 --upload-checksum "sha1 Kq5sNclPz7QV2+lfQIuc6R7oRu0=" --stream "goa.png"
`, os.Args[0])
}
...
Example:
    %[1]s tus delete --id "pkve2enq6e8g6fd0sea4" --tus-resumable "1.0.0"
`, os.Args[0])
}
