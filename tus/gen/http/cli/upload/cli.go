...
func UsageExamples() string {
	return os.Args[0] + ` tus head --id "18uvkaj9f8car5d9dtd2" --tus-resumable "1.0.0"` + "\n" +
		""
}
...
Example:
    %[1]s tus head --id "18uvkaj9f8car5d9dtd2" --tus-resumable "1.0.0"
`, os.Args[0])
}
...
Example:
    %[1]s tus patch --id "p2778bhvb11smi5n6eqe" --tus-resumable "1.0.0" --upload-offset 3237920552917083987 --upload-checksum "sha1 Kq5sNclPz7QV2+lfQIuc6R7oRu0=" --stream "goa.png"
`, os.Args[0])
}
...
Example:
    %[1]s tus delete --id "f87o1c43h88bk365l21j" --tus-resumable "1.0.0"
`, os.Args[0])
}
