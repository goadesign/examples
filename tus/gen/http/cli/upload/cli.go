...
func UsageExamples() string {
	return os.Args[0] + ` tus head --id "p3ive1apdptu8m27fl5b" --tus-resumable "1.0.0"` + "\n" +
		""
}
...
Example:
    %[1]s tus head --id "p3ive1apdptu8m27fl5b" --tus-resumable "1.0.0"
`, os.Args[0])
}
...
Example:
    %[1]s tus patch --id "b1bchv88a0jorn98ipgo" --tus-resumable "1.0.0" --upload-offset 3237920552917083987 --upload-checksum "sha1 Kq5sNclPz7QV2+lfQIuc6R7oRu0=" --stream "goa.png"
`, os.Args[0])
}
...
Example:
    %[1]s tus delete --id "o7las7h03gieodtnu6el" --tus-resumable "1.0.0"
`, os.Args[0])
}
