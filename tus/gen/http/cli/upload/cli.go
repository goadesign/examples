...
func UsageExamples() string {
	return os.Args[0] + ` tus head --id "108j99ldnu9ta1kn3o6n" --tus-resumable "1.0.0"` + "\n" +
		""
}
...
Example:
    %[1]s tus head --id "108j99ldnu9ta1kn3o6n" --tus-resumable "1.0.0"
`, os.Args[0])
}
...
Example:
    %[1]s tus patch --id "ginsrng8p15h14vo5g9e" --tus-resumable "1.0.0" --upload-offset 3237920552917083987 --upload-checksum "sha1 Kq5sNclPz7QV2+lfQIuc6R7oRu0=" --stream "goa.png"
`, os.Args[0])
}
...
Example:
    %[1]s tus delete --id "2qddaud8bbm5gmiifej3" --tus-resumable "1.0.0"
`, os.Args[0])
}
