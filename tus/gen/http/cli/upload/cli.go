...
func UsageExamples() string {
	return os.Args[0] + ` tus head --id "nhkj1u0srpi69162d649" --tus-resumable "1.0.0"` + "\n" +
		""
}
...
Example:
    %[1]s tus head --id "nhkj1u0srpi69162d649" --tus-resumable "1.0.0"
`, os.Args[0])
}
...
Example:
    %[1]s tus patch --id "35dou7i0tvut29bkbol6" --tus-resumable "1.0.0" --upload-offset 3237920552917083987 --upload-checksum "sha1 Kq5sNclPz7QV2+lfQIuc6R7oRu0=" --stream "goa.png"
`, os.Args[0])
}
...
Example:
    %[1]s tus delete --id "it3t2glrrqnc3pa71m4i" --tus-resumable "1.0.0"
`, os.Args[0])
}
