...
func UsageExamples() string {
	return os.Args[0] + ` tus head --id "nbmunmuaom96rtd08ihg" --tus-resumable "1.0.0"` + "\n" +
		""
}
...
Example:
    %[1]s tus head --id "nbmunmuaom96rtd08ihg" --tus-resumable "1.0.0"
`, os.Args[0])
}
...
Example:
    %[1]s tus patch --id "162nav7o171k5ogk3h9p" --tus-resumable "1.0.0" --upload-offset 3237920552917083987 --upload-checksum "sha1 Kq5sNclPz7QV2+lfQIuc6R7oRu0=" --stream "goa.png"
`, os.Args[0])
}
...
Example:
    %[1]s tus delete --id "fr5877d5ksqs8c8nj0d8" --tus-resumable "1.0.0"
`, os.Args[0])
}
