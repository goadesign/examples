...
func UsageExamples() string {
	return os.Args[0] + ` tus head --id "mf596mvbmbctdkegtdeu" --tus-resumable "1.0.0"` + "\n" +
		""
}
...
Example:
    %[1]s tus head --id "mf596mvbmbctdkegtdeu" --tus-resumable "1.0.0"
`, os.Args[0])
}
...
Example:
    %[1]s tus patch --id "upi44fm7hpiroj894rv5" --tus-resumable "1.0.0" --upload-offset 3237920552917083987 --upload-checksum "sha1 Kq5sNclPz7QV2+lfQIuc6R7oRu0=" --stream "goa.png"
`, os.Args[0])
}
...
Example:
    %[1]s tus delete --id "q6l88cnnr22alq51k55g" --tus-resumable "1.0.0"
`, os.Args[0])
}
