...
func UsageExamples() string {
	return os.Args[0] + ` tus head --id "rg1antgjt7mo8pnfu14m" --tus-resumable "1.0.0"` + "\n" +
		""
}
...
Example:
    %[1]s tus head --id "rg1antgjt7mo8pnfu14m" --tus-resumable "1.0.0"
`, os.Args[0])
}
...
Example:
    %[1]s tus patch --id "ke4vsqv86nu5d9m9catb" --tus-resumable "1.0.0" --upload-offset 3237920552917083987 --upload-checksum "sha1 Kq5sNclPz7QV2+lfQIuc6R7oRu0=" --stream "goa.png"
`, os.Args[0])
}
...
Example:
    %[1]s tus delete --id "vl22qlof7kdc30pkeefb" --tus-resumable "1.0.0"
`, os.Args[0])
}
