...
func UsageExamples() string {
	return os.Args[0] + ` tus head --id "3vbp3t5j1soe0lhbccce" --tus-resumable "1.0.0"` + "\n" +
		""
}
...
Example:
    %[1]s tus head --id "3vbp3t5j1soe0lhbccce" --tus-resumable "1.0.0"
`, os.Args[0])
}
...
Example:
    %[1]s tus patch --id "m6kfa5bn90l0q089u2hm" --tus-resumable "1.0.0" --upload-offset 3237920552917083987 --upload-checksum "sha1 Kq5sNclPz7QV2+lfQIuc6R7oRu0=" --stream "goa.png"
`, os.Args[0])
}
...
Example:
    %[1]s tus delete --id "cn6uuf7b0c69v6cm7a3a" --tus-resumable "1.0.0"
`, os.Args[0])
}
