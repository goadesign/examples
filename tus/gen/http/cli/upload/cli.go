...
func UsageExamples() string {
	return os.Args[0] + ` tus head --id "ne41cdoopvhl8rpnqpaq" --tus-resumable "1.0.0"` + "\n" +
		""
}
...
Example:
    %[1]s tus head --id "ne41cdoopvhl8rpnqpaq" --tus-resumable "1.0.0"
`, os.Args[0])
}
...
Example:
    %[1]s tus patch --id "oqhhktuuaomib52v59g1" --tus-resumable "1.0.0" --upload-offset 3237920552917083987 --upload-checksum "sha1 Kq5sNclPz7QV2+lfQIuc6R7oRu0=" --stream "goa.png"
`, os.Args[0])
}
...
Example:
    %[1]s tus delete --id "86ffq7ss193036s1gha1" --tus-resumable "1.0.0"
`, os.Args[0])
}
