...
func UsageExamples() string {
	return os.Args[0] + ` tus head --id "irstpooh39h1al57r2pm" --tus-resumable "1.0.0"` + "\n" +
		""
}
...
Example:
    %[1]s tus head --id "irstpooh39h1al57r2pm" --tus-resumable "1.0.0"
`, os.Args[0])
}
...
Example:
    %[1]s tus patch --id "rgi3vh2nj21m6ekcs9qp" --tus-resumable "1.0.0" --upload-offset 3237920552917083987 --upload-checksum "sha1 Kq5sNclPz7QV2+lfQIuc6R7oRu0=" --stream "goa.png"
`, os.Args[0])
}
...
Example:
    %[1]s tus delete --id "1fpiek8gogfr3002kqec" --tus-resumable "1.0.0"
`, os.Args[0])
}
