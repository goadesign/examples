...
func UsageExamples() string {
	return os.Args[0] + ` tus head --id "epbl83d7ss9p9e1o8qme" --tus-resumable "1.0.0"` + "\n" +
		""
}
...
Example:
    %[1]s tus head --id "epbl83d7ss9p9e1o8qme" --tus-resumable "1.0.0"
`, os.Args[0])
}
...
Example:
    %[1]s tus patch --id "okme8rhpioams48chsnq" --tus-resumable "1.0.0" --upload-offset 3237920552917083987 --upload-checksum "sha1 Kq5sNclPz7QV2+lfQIuc6R7oRu0=" --stream "goa.png"
`, os.Args[0])
}
...
Example:
    %[1]s tus delete --id "s51fj3c7b6qhk2n018d6" --tus-resumable "1.0.0"
`, os.Args[0])
}
