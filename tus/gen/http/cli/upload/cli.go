...
func UsageExamples() string {
	return os.Args[0] + ` tus head --id "kdii43fule6116q8t3qb" --tus-resumable "1.0.0"` + "\n" +
		""
}
...
Example:
    %[1]s tus head --id "kdii43fule6116q8t3qb" --tus-resumable "1.0.0"
`, os.Args[0])
}
...
Example:
    %[1]s tus patch --id "0a04u859acda6gbd3e7j" --tus-resumable "1.0.0" --upload-offset 3237920552917083987 --upload-checksum "sha1 Kq5sNclPz7QV2+lfQIuc6R7oRu0=" --stream "goa.png"
`, os.Args[0])
}
...
Example:
    %[1]s tus delete --id "ulirkjm40i7j27kr9q1v" --tus-resumable "1.0.0"
`, os.Args[0])
}
