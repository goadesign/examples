...
Example:
    %[1]s tus head --id "6m6dfuts16k6ac7a5gna" --tus-resumable "1.0.0"
`, os.Args[0])
}
...
Example:
    %[1]s tus patch --id "84ku3kgoul4sojt5r8un" --tus-resumable "1.0.0" --upload-offset 3237920552917083987 --upload-checksum "sha1 Kq5sNclPz7QV2+lfQIuc6R7oRu0=" --stream "goa.png"
`, os.Args[0])
}
...
Example:
    %[1]s tus delete --id "jevmq4gu2ubgadco02uh" --tus-resumable "1.0.0"
`, os.Args[0])
}
