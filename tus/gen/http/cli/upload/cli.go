...
func UsageExamples() string {
	return os.Args[0] + ` tus head --id "k7ri3pb3p1lkjjoop694" --tus-resumable "1.0.0"` + "\n" +
		""
}
...
Example:
    %[1]s tus head --id "k7ri3pb3p1lkjjoop694" --tus-resumable "1.0.0"
`, os.Args[0])
}
...
Example:
    %[1]s tus patch --id "8lu49fru6unldk82hde8" --tus-resumable "1.0.0" --upload-offset 3237920552917083987 --upload-checksum "sha1 Kq5sNclPz7QV2+lfQIuc6R7oRu0=" --stream "goa.png"
`, os.Args[0])
}
...
Example:
    %[1]s tus delete --id "cmuief3ig3c1uhmb9smf" --tus-resumable "1.0.0"
`, os.Args[0])
}
