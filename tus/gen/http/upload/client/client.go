...
// Head returns an endpoint that makes HTTP requests to the upload service head
// server.
func (c *Client) Head() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("upload", "head", err)
		}
		return decodeResponse(resp)
	}
}

// Patch returns an endpoint that makes HTTP requests to the upload service
// patch server.
func (c *Client) Patch() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("upload", "patch", err)
		}
		return decodeResponse(resp)
	}
}

// Options returns an endpoint that makes HTTP requests to the upload service
// options server.
func (c *Client) Options() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("upload", "options", err)
		}
		return decodeResponse(resp)
	}
}

// Post returns an endpoint that makes HTTP requests to the upload service post
// server.
func (c *Client) Post() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("upload", "post", err)
		}
		return decodeResponse(resp)
	}
}

// Delete returns an endpoint that makes HTTP requests to the upload service
// delete server.
func (c *Client) Delete() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("upload", "delete", err)
		}
		return decodeResponse(resp)
	}
}
