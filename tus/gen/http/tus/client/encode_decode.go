...
func (c *Client) BuildHeadRequest(ctx context.Context, v any) (*http.Request, error) {
	var (
		id string
	)
	{
...
// server.
func EncodeHeadRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
	...
	return func(resp *http.Response) (any, error) {
		...
		case http.StatusOK:
			...
			err = goa.MergeErrors(err, goa.ValidatePattern("tusResumable", tusResumable, "^(0|[1-9]\\d*)\\.(0|[1-9]\\d*)\\.(0|[1-9]\\d*)(-(0|[1-9]\\d*|\\d*[a-zA-Z-][0-9a-zA-Z-]*)(\\.(0|[1-9]\\d*|\\d*[a-zA-Z-][0-9a-zA-Z-]*))*)?(\\+[0-9a-zA-Z-]+(\\.[0-9a-zA-Z-]+)*)?$"))
			{
				...
				if uploadOffsetRaw == "" {
					return nil, goahttp.ErrValidationError("tus", "head", goa.MissingFieldError("uploadOffset", "header"))
				}
		...
		case http.StatusNotFound:
			...
			message = messageRaw
			{
				...
				if temporaryRaw == "" {
					return nil, goahttp.ErrValidationError("tus", "head", goa.MissingFieldError("temporary", "header"))
				}
			...
			}
			{
				...
				if timeoutRaw == "" {
					return nil, goahttp.ErrValidationError("tus", "head", goa.MissingFieldError("timeout", "header"))
				}
			...
			}
			{
				...
				if faultRaw == "" {
					return nil, goahttp.ErrValidationError("tus", "head", goa.MissingFieldError("fault", "header"))
				}
		...
		case http.StatusPreconditionFailed:
			...
			if !(tusVersion == "1.0.0") {
				err = goa.MergeErrors(err, goa.InvalidEnumValueError("tusVersion", tusVersion, []any{"1.0.0"}))
			}
			if err != nil {
				return nil, goahttp.ErrValidationError("tus", "head", err)
			}
	...
	return func(resp *http.Response) (any, error) {
		...
		case http.StatusNoContent:
			...
			err = goa.MergeErrors(err, goa.ValidatePattern("tusResumable", tusResumable, "^(0|[1-9]\\d*)\\.(0|[1-9]\\d*)\\.(0|[1-9]\\d*)(-(0|[1-9]\\d*|\\d*[a-zA-Z-][0-9a-zA-Z-]*)(\\.(0|[1-9]\\d*|\\d*[a-zA-Z-][0-9a-zA-Z-]*))*)?(\\+[0-9a-zA-Z-]+(\\.[0-9a-zA-Z-]+)*)?$"))
			{
				uploadOffsetRaw := resp.Header.Get("Upload-Offset")
				if uploadOffsetRaw == "" {
					return nil, goahttp.ErrValidationError("tus", "patch", goa.MissingFieldError("uploadOffset", "header"))
				}
				v, err2 := strconv.ParseInt(uploadOffsetRaw, 10, 64)
				if err2 != nil {
					err = goa.MergeErrors(err, goa.InvalidFieldTypeError("uploadOffset", uploadOffsetRaw, "integer"))
		...
		case http.StatusUnsupportedMediaType:
			...
			message = messageRaw
			{
				temporaryRaw := resp.Header.Get("Goa-Attribute-Temporary")
				if temporaryRaw == "" {
					return nil, goahttp.ErrValidationError("tus", "patch", goa.MissingFieldError("temporary", "header"))
				}
				v, err2 := strconv.ParseBool(temporaryRaw)
				if err2 != nil {
					err = goa.MergeErrors(err, goa.InvalidFieldTypeError("temporary", temporaryRaw, "boolean"))
			...
			}
			{
				timeoutRaw := resp.Header.Get("Goa-Attribute-Timeout")
				if timeoutRaw == "" {
					return nil, goahttp.ErrValidationError("tus", "patch", goa.MissingFieldError("timeout", "header"))
				}
				v, err2 := strconv.ParseBool(timeoutRaw)
				if err2 != nil {
					err = goa.MergeErrors(err, goa.InvalidFieldTypeError("timeout", timeoutRaw, "boolean"))
			...
			}
			{
				faultRaw := resp.Header.Get("Goa-Attribute-Fault")
				if faultRaw == "" {
					return nil, goahttp.ErrValidationError("tus", "patch", goa.MissingFieldError("fault", "header"))
				}
				v, err2 := strconv.ParseBool(faultRaw)
				if err2 != nil {
					err = goa.MergeErrors(err, goa.InvalidFieldTypeError("fault", faultRaw, "boolean"))
...
func BuildPatchStreamPayload(payload any, fpath string) (*tus.PatchRequestData, error) {
	f, err := os.Open(fpath)
	if err != nil {
		return nil, err
	}
...
func (c *Client) BuildOptionsRequest(ctx context.Context, v any) (*http.Request, error) {
	...
	return func(resp *http.Response) (any, error) {
		...
		case http.StatusNoContent:
			...
			if !(tusExtension == "creation,creation-with-upload,creation-defer-length,expiration,checksum,termination") {
				err = goa.MergeErrors(err, goa.InvalidEnumValueError("tusExtension", tusExtension, []any{"creation,creation-with-upload,creation-defer-length,expiration,checksum,termination"}))
			}
			{
			...
			if !(tusChecksumAlgorithm == "md5,sha1,crc32") {
				err = goa.MergeErrors(err, goa.InvalidEnumValueError("tusChecksumAlgorithm", tusChecksumAlgorithm, []any{"md5,sha1,crc32"}))
			}
			if err != nil {
...
func (c *Client) BuildPostRequest(ctx context.Context, v any) (*http.Request, error) {
	var (
		body io.Reader
	)
...
// server.
func EncodePostRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
	return func(req *http.Request, v any) error {
	...
	return func(resp *http.Response) (any, error) {
		...
		case http.StatusCreated:
			...
			err = goa.MergeErrors(err, goa.ValidatePattern("tusResumable", tusResumable, "^(0|[1-9]\\d*)\\.(0|[1-9]\\d*)\\.(0|[1-9]\\d*)(-(0|[1-9]\\d*|\\d*[a-zA-Z-][0-9a-zA-Z-]*)(\\.(0|[1-9]\\d*|\\d*[a-zA-Z-][0-9a-zA-Z-]*))*)?(\\+[0-9a-zA-Z-]+(\\.[0-9a-zA-Z-]+)*)?$"))
			{
				uploadOffsetRaw := resp.Header.Get("Upload-Offset")
				if uploadOffsetRaw == "" {
					return nil, goahttp.ErrValidationError("tus", "post", goa.MissingFieldError("uploadOffset", "header"))
				}
				v, err2 := strconv.ParseInt(uploadOffsetRaw, 10, 64)
				if err2 != nil {
					err = goa.MergeErrors(err, goa.InvalidFieldTypeError("uploadOffset", uploadOffsetRaw, "integer"))
		...
		case http.StatusBadRequest:
			...
			case "MissingHeader":
				...
				message = messageRaw
				{
					temporaryRaw := resp.Header.Get("Goa-Attribute-Temporary")
					if temporaryRaw == "" {
						return nil, goahttp.ErrValidationError("tus", "post", goa.MissingFieldError("temporary", "header"))
					}
					v, err2 := strconv.ParseBool(temporaryRaw)
					if err2 != nil {
						err = goa.MergeErrors(err, goa.InvalidFieldTypeError("temporary", temporaryRaw, "boolean"))
				...
				}
				{
					timeoutRaw := resp.Header.Get("Goa-Attribute-Timeout")
					if timeoutRaw == "" {
						return nil, goahttp.ErrValidationError("tus", "post", goa.MissingFieldError("timeout", "header"))
					}
					v, err2 := strconv.ParseBool(timeoutRaw)
					if err2 != nil {
						err = goa.MergeErrors(err, goa.InvalidFieldTypeError("timeout", timeoutRaw, "boolean"))
				...
				}
				{
					faultRaw := resp.Header.Get("Goa-Attribute-Fault")
					if faultRaw == "" {
						return nil, goahttp.ErrValidationError("tus", "post", goa.MissingFieldError("fault", "header"))
					}
					v, err2 := strconv.ParseBool(faultRaw)
					if err2 != nil {
						err = goa.MergeErrors(err, goa.InvalidFieldTypeError("fault", faultRaw, "boolean"))
...
func BuildPostStreamPayload(payload any, fpath string) (*tus.PostRequestData, error) {
	f, err := os.Open(fpath)
	if err != nil {
		return nil, err
	}
	...
	return func(resp *http.Response) (any, error) {
		...
		case http.StatusNotFound:
			...
			message = messageRaw
			{
				temporaryRaw := resp.Header.Get("Goa-Attribute-Temporary")
				if temporaryRaw == "" {
					return nil, goahttp.ErrValidationError("tus", "delete", goa.MissingFieldError("temporary", "header"))
				}
				v, err2 := strconv.ParseBool(temporaryRaw)
				if err2 != nil {
					err = goa.MergeErrors(err, goa.InvalidFieldTypeError("temporary", temporaryRaw, "boolean"))
			...
			}
			{
				timeoutRaw := resp.Header.Get("Goa-Attribute-Timeout")
				if timeoutRaw == "" {
					return nil, goahttp.ErrValidationError("tus", "delete", goa.MissingFieldError("timeout", "header"))
				}
				v, err2 := strconv.ParseBool(timeoutRaw)
				if err2 != nil {
					err = goa.MergeErrors(err, goa.InvalidFieldTypeError("timeout", timeoutRaw, "boolean"))
			...
			}
			{
				faultRaw := resp.Header.Get("Goa-Attribute-Fault")
				if faultRaw == "" {
					return nil, goahttp.ErrValidationError("tus", "delete", goa.MissingFieldError("fault", "header"))
				}
				v, err2 := strconv.ParseBool(faultRaw)
				if err2 != nil {
					err = goa.MergeErrors(err, goa.InvalidFieldTypeError("fault", faultRaw, "boolean"))
