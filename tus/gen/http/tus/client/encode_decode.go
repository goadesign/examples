...
func DecodeHeadResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (interface{}, error) {
	return func(resp *http.Response) (interface{}, error) {
		...
		case http.StatusNotFound:
			return nil, NewHeadNotFound()
		case http.StatusGone:
			return nil, NewHeadGone()
...
func DecodePatchResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (interface{}, error) {
	return func(resp *http.Response) (interface{}, error) {
		...
		case http.StatusUnsupportedMediaType:
			return nil, NewPatchInvalidContentType()
		case http.StatusConflict:
			return nil, NewPatchInvalidOffset()
		case http.StatusNotFound:
			return nil, NewPatchNotFound()
		case http.StatusGone:
			return nil, NewPatchGone()
		case http.StatusBadRequest:
			return nil, NewPatchInvalidChecksumAlgorithm()
		case 460:
			return nil, NewPatchChecksumMismatch()
		case http.StatusInternalServerError:
			return nil, NewPatchInternal()
		case http.StatusPreconditionFailed:
			var (
				tusVersion string
				err        error
...
func DecodePostResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (interface{}, error) {
	return func(resp *http.Response) (interface{}, error) {
		...
		case http.StatusBadRequest:
			...
			switch en {
			case "MissingHeader":
				return nil, NewPostMissingHeader()
			case "InvalidDeferLength":
				return nil, NewPostInvalidDeferLength()
			case "InvalidChecksumAlgorithm":
				return nil, NewPostInvalidChecksumAlgorithm()
			default:
				body, _ := ioutil.ReadAll(resp.Body)
				return nil, goahttp.ErrInvalidResponse("tus", "post", resp.StatusCode, string(body))
			}
		case http.StatusRequestEntityTooLarge:
			return nil, NewPostMaximumSizeExceeded()
		case 460:
			return nil, NewPostChecksumMismatch()
		case http.StatusPreconditionFailed:
			var (
				tusVersion string
				err        error
...
func DecodeDeleteResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (interface{}, error) {
	return func(resp *http.Response) (interface{}, error) {
		...
		case http.StatusNoContent:
			...
			return res, nil
		case http.StatusNotFound:
			return nil, NewDeleteNotFound()
		case http.StatusGone:
			return nil, NewDeleteGone()
		case http.StatusPreconditionFailed:
			var (
				tusVersion string
				err        error
