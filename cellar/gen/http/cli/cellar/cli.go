	...
	)
	{
		...
		case "storage":
			...
			case "rate":
				...
				data = val
				if err != nil {
					return nil, nil, fmt.Errorf("invalid JSON for storageRatePFlag, \nerror: %s, \nexample of valid JSON:\n%s", err, "'{\n      \"\\u003cuint32 Value\\u003e\": [\n         \"Recusandae repellat molestiae consequatur recusandae.\",\n         \"Modi qui et sunt harum fugiat.\"\n      ]\n   }'")
				}
			case "multi-add":
...
func storageShowUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], "storage show --id \"Et aut a enim qui.\" --view \"tiny\"")
}
...
func storageRemoveUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], "storage remove --id \"Id libero accusantium incidunt.\"")
}
