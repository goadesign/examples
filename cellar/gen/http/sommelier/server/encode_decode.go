...
// endpoint.
func DecodePickRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*sommelier.Criteria, error) {
	return func(r *http.Request) (*sommelier.Criteria, error) {
...
func marshalSommelierviewsStoredBottleViewToStoredBottleResponse(v *sommelierviews.StoredBottleView) *StoredBottleResponse {
	...
	if v.Composition != nil {
		...
		for i, val := range v.Composition {
			...
			res.Composition[i] = marshalSommelierviewsComponentViewToComponentResponseOptional(val)
		}
	}
...
// marshalSommelierviewsComponentViewToComponentResponseOptional builds a value
// of type *ComponentResponse from a value of type
// *sommelierviews.ComponentView.
func marshalSommelierviewsComponentViewToComponentResponseOptional(v *sommelierviews.ComponentView) *ComponentResponse {
	if v == nil {
		return nil
	}
