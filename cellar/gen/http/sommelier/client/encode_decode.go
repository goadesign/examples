...
func DecodePickResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		...
		case http.StatusOK:
			var (
				body StoredBottleResponseCollection
				err  error
			)
...
func unmarshalStoredBottleResponseToSommelierviewsStoredBottleView(v *StoredBottleResponse) *sommelierviews.StoredBottleView {
	...
	res.Winery = unmarshalWineryResponseTinyToSommelierviewsWineryView(v.Winery)
...
// unmarshalWineryResponseTinyToSommelierviewsWineryView builds a value of type
// *sommelierviews.WineryView from a value of type *WineryResponseTiny.
func unmarshalWineryResponseTinyToSommelierviewsWineryView(v *WineryResponseTiny) *sommelierviews.WineryView {
