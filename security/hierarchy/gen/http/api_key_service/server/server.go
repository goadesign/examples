...
// New instantiates HTTP handlers for all the api_key_service service endpoints
...
func (s *Server) Service() string { return "api_key_service" }
...
func (s *Server) MethodNames() []string { return apikeyservice.MethodNames[:] }
...
// MountDefaultHandler configures the mux to serve the "api_key_service"
...
func MountDefaultHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/svc/default", f)
}

// NewDefaultHandler creates a HTTP handler which loads the HTTP request and
// calls the "api_key_service" service "default" endpoint.
...
// MountSecureHandler configures the mux to serve the "api_key_service" service
// "secure" endpoint.
func MountSecureHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/svc/secure", f)
}

// NewSecureHandler creates a HTTP handler which loads the HTTP request and
// calls the "api_key_service" service "secure" endpoint.
