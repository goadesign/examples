...
func ParseEndpoint(
	...
	var (
		...
		defaultServiceDefaultUsernameFlag = defaultServiceDefaultFlags.String("username", "", "")
		defaultServiceDefaultPasswordFlag = defaultServiceDefaultFlags.String("password", "", "")
