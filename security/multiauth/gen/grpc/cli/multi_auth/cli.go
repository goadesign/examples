...
Example:
    %[1]s secured-service secure --message '{
      "fail": false
   }' --token "Ut molestiae aut et voluptas magni."
`, os.Args[0])
}
...
Example:
    %[1]s secured-service also-doubly-secure --message '{
      ...
      "password": "password",
      "username": "user"
   }' --oauth-token "Ducimus est et alias numquam cum accusantium." --token "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWV9.TJVA95OrM7E2cBab30RMHrHDcEfxjoYZgeFONFh7HgQ"
`, os.Args[0])
}
