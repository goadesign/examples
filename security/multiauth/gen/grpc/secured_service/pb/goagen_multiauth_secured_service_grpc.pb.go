...
const (
	...
	SecuredService_BearerSecure_FullMethodName     = "/secured_service.SecuredService/BearerSecure"
...
type SecuredServiceClient interface {
	...
	BearerSecure(ctx context.Context, in *BearerSecureRequest, opts ...grpc.CallOption) (*BearerSecureResponse, error)
...
func (c *securedServiceClient) BearerSecure(ctx context.Context, in *BearerSecureRequest, opts ...grpc.CallOption) (*BearerSecureResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BearerSecureResponse)
	err := c.cc.Invoke(ctx, SecuredService_BearerSecure_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SecuredServiceServer interface {
	...
	// This action is secured with the bearer scheme
	BearerSecure(context.Context, *BearerSecureRequest) (*BearerSecureResponse, error)
	// This action is secured with the jwt scheme and also requires an API key
	// query string.
...
func (UnimplementedSecuredServiceServer) BearerSecure(context.Context, *BearerSecureRequest) (*BearerSecureResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method BearerSecure not implemented")
}
func (UnimplementedSecuredServiceServer) DoublySecure(context.Context, *DoublySecureRequest) (*DoublySecureResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DoublySecure not implemented")
}
func (UnimplementedSecuredServiceServer) AlsoDoublySecure(context.Context, *AlsoDoublySecureRequest) (*AlsoDoublySecureResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AlsoDoublySecure not implemented")
}
...
func RegisterSecuredServiceServer(s grpc.ServiceRegistrar, srv SecuredServiceServer) {
	// If the following call panics, it indicates UnimplementedSecuredServiceServer was
...
func _SecuredService_BearerSecure_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BearerSecureRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SecuredServiceServer).BearerSecure(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SecuredService_BearerSecure_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SecuredServiceServer).BearerSecure(ctx, req.(*BearerSecureRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SecuredService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BearerSecure",
			Handler:    _SecuredService_BearerSecure_Handler,
		},
		{
