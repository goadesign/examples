...
func (x *SigninResponse) GetBearerToken() string {
	if x != nil {
...
type BearerSecureRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *BearerSecureRequest) Reset() {
	*x = BearerSecureRequest{}
	mi := &file_goagen_multiauth_secured_service_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BearerSecureRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BearerSecureRequest) ProtoMessage() {}

func (x *BearerSecureRequest) ProtoReflect() protoreflect.Message {
	mi := &file_goagen_multiauth_secured_service_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BearerSecureRequest.ProtoReflect.Descriptor instead.
func (*BearerSecureRequest) Descriptor() ([]byte, []int) {
	return file_goagen_multiauth_secured_service_proto_rawDescGZIP(), []int{4}
}

type BearerSecureResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Field         string                 `protobuf:"bytes,1,opt,name=field,proto3" json:"field,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *BearerSecureResponse) Reset() {
	*x = BearerSecureResponse{}
	mi := &file_goagen_multiauth_secured_service_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BearerSecureResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BearerSecureResponse) ProtoMessage() {}

func (x *BearerSecureResponse) ProtoReflect() protoreflect.Message {
	mi := &file_goagen_multiauth_secured_service_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BearerSecureResponse.ProtoReflect.Descriptor instead.
func (*BearerSecureResponse) Descriptor() ([]byte, []int) {
	return file_goagen_multiauth_secured_service_proto_rawDescGZIP(), []int{5}
}

func (x *BearerSecureResponse) GetField() string {
	if x != nil {
		return x.Field
	}
	return ""
...
func (x *AlsoDoublySecureRequest) Reset() {
	*x = AlsoDoublySecureRequest{}
	mi := &file_goagen_multiauth_secured_service_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AlsoDoublySecureRequest) Descriptor() ([]byte, []int) {
	return file_goagen_multiauth_secured_service_proto_rawDescGZIP(), []int{8}
}
...
func (x *AlsoDoublySecureResponse) Reset() {
	*x = AlsoDoublySecureResponse{}
	mi := &file_goagen_multiauth_secured_service_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AlsoDoublySecureResponse) Descriptor() ([]byte, []int) {
	return file_goagen_multiauth_secured_service_proto_rawDescGZIP(), []int{9}
}
...
var file_goagen_multiauth_secured_service_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_goagen_multiauth_secured_service_proto_goTypes = []any{
	...
	(*AlsoDoublySecureRequest)(nil),  // 8: secured_service.AlsoDoublySecureRequest
	(*AlsoDoublySecureResponse)(nil), // 9: secured_service.AlsoDoublySecureResponse
}
var file_goagen_multiauth_secured_service_proto_depIdxs = []int32{
	...
	4, // 2: secured_service.SecuredService.BearerSecure:input_type -> secured_service.BearerSecureRequest
	6, // 3: secured_service.SecuredService.DoublySecure:input_type -> secured_service.DoublySecureRequest
	8, // 4: secured_service.SecuredService.AlsoDoublySecure:input_type -> secured_service.AlsoDoublySecureRequest
	1, // 5: secured_service.SecuredService.Signin:output_type -> secured_service.SigninResponse
	3, // 6: secured_service.SecuredService.Secure:output_type -> secured_service.SecureResponse
	5, // 7: secured_service.SecuredService.BearerSecure:output_type -> secured_service.BearerSecureResponse
...
func file_goagen_multiauth_secured_service_proto_init() {
	...
	file_goagen_multiauth_secured_service_proto_msgTypes[8].OneofWrappers = []any{}
	type x struct{}
