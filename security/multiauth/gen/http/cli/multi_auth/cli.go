...
func securedServiceSecureUsage() {
	fmt.Fprintf(os.Stderr, `%[1]s [flags] secured-service secure -fail BOOL -token STRING
...
Example:
    %[1]s secured-service secure --fail true --token "Quae deleniti molestiae."
`, os.Args[0])
}

func securedServiceDoublySecureUsage() {
	fmt.Fprintf(os.Stderr, `%[1]s [flags] secured-service doubly-secure -key STRING -token STRING
...
Example:
    %[1]s secured-service doubly-secure --key "abcdef12345" --token "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWV9.TJVA95OrM7E2cBab30RMHrHDcEfxjoYZgeFONFh7HgQ"
`, os.Args[0])
}

func securedServiceAlsoDoublySecureUsage() {
	fmt.Fprintf(os.Stderr, `%[1]s [flags] secured-service also-doubly-secure -key STRING -oauth-token STRING -token STRING -username STRING -password STRING
...
Example:
    %[1]s secured-service also-doubly-secure --key "abcdef12345" --oauth-token "Quia consequuntur assumenda magnam nostrum sed optio." --token "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWV9.TJVA95OrM7E2cBab30RMHrHDcEfxjoYZgeFONFh7HgQ" --username "user" --password "password"
`, os.Args[0])
}
