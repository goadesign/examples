...
Example:
    %[1]s secured-service also-doubly-secure --key "abcdef12345" --oauth-token "Qui debitis facilis ut ut." --token "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWV9.TJVA95OrM7E2cBab30RMHrHDcEfxjoYZgeFONFh7HgQ" --username "user" --password "password"
`, os.Args[0])
}
