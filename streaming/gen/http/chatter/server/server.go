...
func NewEchoerHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if err != nil {
			if v.Stream.(*EchoerServerStream).conn != nil {
...
func NewListenerHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		_, err = endpoint(ctx, v)
		if err != nil {
			if v.Stream.(*ListenerServerStream).conn != nil {
				// Response writer has been hijacked, do not encode the error
				errhandler(ctx, w, err)
				return
			}
...
func NewSummaryHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		_, err = endpoint(ctx, v)
		if err != nil {
			if v.Stream.(*SummaryServerStream).conn != nil {
				// Response writer has been hijacked, do not encode the error
				errhandler(ctx, w, err)
				return
			}
...
func NewHistoryHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		_, err = endpoint(ctx, v)
		if err != nil {
			if v.Stream.(*HistoryServerStream).conn != nil {
				// Response writer has been hijacked, do not encode the error
				errhandler(ctx, w, err)
				return
			}
