...
// SendWithContext streams instances of "string" to the "echoer" endpoint
// websocket connection with context.
func (s *EchoerServerStream) SendWithContext(ctx context.Context, v string) error {
	return s.Send(v)
}
...
// RecvWithContext reads instances of "string" from the "echoer" endpoint
// websocket connection with context.
...
// RecvWithContext reads instances of "string" from the "listener" endpoint
// websocket connection with context.
...
// SendAndCloseWithContext streams instances of "chatter.ChatSummaryCollection"
// to the "summary" endpoint websocket connection with context and closes the
// connection.
func (s *SummaryServerStream) SendAndCloseWithContext(ctx context.Context, v chatter.ChatSummaryCollection) error {
...
// RecvWithContext reads instances of "string" from the "summary" endpoint
// websocket connection with context.
...
// SendWithContext streams instances of "chatter.Event" to the "subscribe"
// endpoint websocket connection with context.
func (s *SubscribeServerStream) SendWithContext(ctx context.Context, v *chatter.Event) error {
	return s.Send(v)
}
...
// endpoint websocket connection with context.
func (s *HistoryServerStream) SendWithContext(ctx context.Context, v *chatter.ChatSummary) error {
	return s.Send(v)
}
