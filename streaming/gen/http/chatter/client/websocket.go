...
// websocket connection with context.
func (s *EchoerClientStream) SendWithContext(ctx context.Context, v string) error {
	return s.Send(v)
}
...
// SendWithContext streams instances of "string" to the "listener" endpoint
// websocket connection with context.
func (s *ListenerClientStream) SendWithContext(ctx context.Context, v string) error {
	return s.Send(v)
}
...
// CloseAndRecvWithContext stops sending messages to the "summary" endpoint
// websocket connection and reads instances of "chatter.ChatSummaryCollection"
...
// SendWithContext streams instances of "string" to the "summary" endpoint
// websocket connection with context.
func (s *SummaryClientStream) SendWithContext(ctx context.Context, v string) error {
	return s.Send(v)
}
...
// RecvWithContext reads instances of "chatter.Event" from the "subscribe"
