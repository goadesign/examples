...
Example:
    %[1]s chatter echoer --token "Deleniti ea in."
`, os.Args[0])
}
...
Example:
    %[1]s chatter listener --token "Molestiae autem voluptatem voluptate autem incidunt."
`, os.Args[0])
}
...
Example:
    %[1]s chatter summary --token "Iure voluptatem blanditiis non."
`, os.Args[0])
}
...
Example:
    %[1]s chatter subscribe --token "Nihil veniam nihil."
`, os.Args[0])
}
...
Example:
    %[1]s chatter history --view "Dignissimos sed perspiciatis similique." --token "Eligendi vel ut porro minima ut unde."
`, os.Args[0])
}
