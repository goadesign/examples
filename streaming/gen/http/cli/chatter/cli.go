...
Example:
    %[1]s chatter echoer --token "Sit rerum sit et hic."
`, os.Args[0])
}
...
Example:
    %[1]s chatter listener --token "Aut sunt fugit exercitationem."
`, os.Args[0])
}
...
Example:
    %[1]s chatter summary --token "Quas soluta rerum voluptatum."
`, os.Args[0])
}
...
Example:
    %[1]s chatter subscribe --token "Libero ullam."
`, os.Args[0])
}
...
Example:
    %[1]s chatter history --view "Rerum hic fugit commodi laudantium." --token "Aut tempore quae minus ducimus consequatur."
`, os.Args[0])
}
