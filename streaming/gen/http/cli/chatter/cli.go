...
Example:
    %[1]s chatter listener --token "Cumque cupiditate aperiam suscipit enim."
`, os.Args[0])
}
...
Example:
    %[1]s chatter summary --token "Iusto aut saepe."
`, os.Args[0])
}
...
Example:
    %[1]s chatter subscribe --token "Iure voluptatem blanditiis non."
`, os.Args[0])
}
...
Example:
    %[1]s chatter history --view "Commodi sapiente libero doloribus." --token "Vel quidem error explicabo."
`, os.Args[0])
}
