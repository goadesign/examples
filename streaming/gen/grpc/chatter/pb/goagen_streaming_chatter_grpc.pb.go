...
func RegisterChatterServer(s grpc.ServiceRegistrar, srv ChatterServer) {
	// If the following call panics, it indicates UnimplementedChatterServer was
