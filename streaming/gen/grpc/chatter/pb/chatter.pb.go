...
func (*ListenerResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3ba0d1307119797e, []int{5}
}
...
func (*SummaryStreamingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_3ba0d1307119797e, []int{6}
}
...
func (*ChatSummaryCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_3ba0d1307119797e, []int{7}
}
...
func (*ChatSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_3ba0d1307119797e, []int{8}
}
...
func (*SubscribeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_3ba0d1307119797e, []int{9}
}
...
func (*SubscribeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3ba0d1307119797e, []int{10}
}
...
func (*HistoryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_3ba0d1307119797e, []int{11}
}
...
func (*HistoryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3ba0d1307119797e, []int{12}
}
