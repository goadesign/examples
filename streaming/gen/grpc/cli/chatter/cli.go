...
Example:
    %[1]s chatter echoer --token "Dolores nisi qui est accusamus veniam tenetur."
`, os.Args[0])
}
...
Example:
    %[1]s chatter listener --token "Tempora repudiandae ipsa aut."
`, os.Args[0])
}
...
Example:
    %[1]s chatter summary --token "Consequatur rerum."
`, os.Args[0])
}
...
Example:
    %[1]s chatter subscribe --token "Ullam quo et."
`, os.Args[0])
}
...
Example:
    %[1]s chatter history --view "Ipsa quia quia." --token "Aut corrupti iure."
`, os.Args[0])
}
