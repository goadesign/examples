...
//   - "invalid-scopes" (type InvalidScopes)
//   - error: internal error
func (c *Client) Subscribe(ctx context.Context, p *SubscribePayload) (err error) {
	_, err = c.SubscribeEndpoint(ctx, p)
	return
}
...
//   - "invalid-scopes" (type InvalidScopes)
//   - error: internal error
func (c *Client) History(ctx context.Context, p *HistoryPayload) (err error) {
	_, err = c.HistoryEndpoint(ctx, p)
	return
}
