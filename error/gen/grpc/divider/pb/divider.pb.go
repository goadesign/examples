...
func (*IntegerDivideRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_b61a15f9edfd6d51, []int{0}
}
...
func (m *IntegerDivideRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IntegerDivideRequest.Merge(m, src)
}
...
func (*IntegerDivideResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b61a15f9edfd6d51, []int{1}
}
...
func (m *IntegerDivideResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IntegerDivideResponse.Merge(m, src)
}
...
func (*DivideRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_b61a15f9edfd6d51, []int{2}
}
...
func (*DivideResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b61a15f9edfd6d51, []int{3}
}
...
func init() { proto.RegisterFile("divider.proto", fileDescriptor_b61a15f9edfd6d51) }

var fileDescriptor_b61a15f9edfd6d51 = []byte{
